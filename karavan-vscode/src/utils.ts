...
/**
 * reads and parses the given path as a yaml file and returns a YamlLeaf.                                  
 * `null` if error while parsing.                                               
 * @returns {YamlLeaf}
 */

export function parseYamlFile(yamlPath: string): YamlLeaf | null {
    try {
