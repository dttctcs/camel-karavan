...
import { ReferenceConfigurationDefinition, BeanFactoryDefinition, RouteConfigurationDefinition, RouteDefinition, StreamCachingDefinition } from '../model/CamelDefinition';
